...
function mychildtheme_enqueue_styles(){
    wp_enqueue_style( 'parent-style', get_template_directory_uri() . '/style.css', array(), rand(), 'all' );
    wp_enqueue_script('googleapis', 'https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js', array(), null, true);
    wp_enqueue_script('myscript', get_stylesheet_directory_uri() . '/scripts.js', array(), rand(), 'all' );
}
