...
if ( ! class_exists( 'AWL_Admin_Notices' ) ) :
    ...
    class AWL_Admin_Notices {
        ...
        public function plugins_integration_notice() {
            ...
            if ( ! class_exists( 'WCFMmp' ) && ! class_exists('ACF') && ! class_exists( 'WC_Product_Table_Plugin' ) && ! class_exists( 'YITH_WCWL' ) && ! class_exists( 'WeDevs_Dokan' ) && ! defined( 'PWB_PLUGIN_VERSION' ) ) {
                return;
            }
